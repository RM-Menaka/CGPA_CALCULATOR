...
Backend logic in PHP

GPA/CGPA calculation using credit-weighted formulas

Basic web application structure with modular scripts
...
Store academic records in a structured database

Calculate GPA based on grade points and credits

Compute cumulative CGPA across semesters
...
C:\xampp\htdocs\CGPA_CALCULATOR
